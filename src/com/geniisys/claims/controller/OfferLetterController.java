...
public class OfferLetterController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String page = "/pages/claims/Offer Letter/offerLetter.jsp";
		...
		if (action.equals("toOfferLetterPage")) {
			...
			request.setAttribute("pageTitle", "Motor Car - Offer Letter (Total Loss/Carnap)");
		...
		if (action.equals("checkClaimNo")) {
			...
			List<OfferLetter> offerLetter = null;
			ClaimNo claimNo = null;
			try {
				claimNo = (ClaimNo) demandLetterService.prepareClaimNo(request);
				offerLetter = (List<OfferLetter>) offerLetterService.fetchOfferLetter(claimNo);
				Integer listSize = offerLetter.size();
				...
				request.setAttribute("offerLetter", offerLetter);
		...
		if (action.equals("printOfferLetter")) {
			// claimNo
			...
			String chkBox13a = request.getParameter("chkBox13a");
			String chkBox13b = request.getParameter("chkBox13b");
			String chkBox14 = request.getParameter("chkBox14");
			String chkBox14a = request.getParameter("chkBox14a");
			...
			parameters.put("P_DS_TO", chkBox13a);
			parameters.put("P_DS_FROM", chkBox13b);
			parameters.put("P_NC_TAG14", chkBox14);
			parameters.put("P_OR_CR_DATE", chkBox14a);
